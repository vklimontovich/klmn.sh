          ...
          <div className={`mb-6 ${styles.headerSection}`}>
            <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
              ...
              <button
                ...
                className={`flex items-center gap-1 text-sm text-gray-600 hover:text-gray-900 underline md:no-underline md:px-4 md:py-2 md:bg-black md:text-white md:rounded-md md:hover:bg-gray-800 transition-colors md:flex-shrink-0 ${styles.downloadButton}`}
              >
